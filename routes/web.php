...
//Select Company
Route::get('/SelectCompany', $controller_path . '\auditsme\SelectCompany@index')->name('select-company');

//Data Preparation
Route::get('/preparation/paf', $controller_path . '\auditsme\PAF@index')->name('preparation-paf');
Route::get('/preparation/CompanyInformation', $controller_path . '\auditsme\CompanyInformation@index')->name('preparation-company-information');
Route::get('/preparation/StatutoryAudit', $controller_path . '\auditsme\StatutoryAudit@index')->name('preparation-statutory-audit');
Route::get('/preparation/AccountImport', $controller_path . '\auditsme\AccountImport@index')->name('preparation-account-import');
Route::get('/preparation/AccountGrouping', $controller_path . '\auditsme\AccountGrouping@index')->name('preparation-account-grouping');


// Audit Planning
Route::get('/planning/AuditProgramme', $controller_path . '\auditsme\AuditProgramme@index')->name('planning-audit-programme');
Route::get('/planning/InitialPM', $controller_path . '\auditsme\InitialPM@index')->name('planning-initial-pm');

//Audit Work
Route::get('/work/LeadSchedule', $controller_path . '\auditsme\LeadSchedule@index')->name('work-lead-schedule');
Route::get('/work/AuditLetter', $controller_path . '\auditsme\AuditLetter@index')->name('work-audit-letter');

//Audit Completion

Route::get('/completion/AuditCompletion', $controller_path . '\auditsme\AuditCompletion@index')->name('completion-audit-completion');
Route::get('/completion/FinalPM', $controller_path . '\auditsme\FinalPM@index')->name('completion-final-pm');


//Financial Statement
Route::get('/reporting/FinancialStatement', $controller_path . '\auditsme\FinancialStatement@index')->name('reporting-financial-statement');
Route::get('/reporting/MBRS', $controller_path . '\auditsme\MBRS@index')->name('reporting-mbrs');
